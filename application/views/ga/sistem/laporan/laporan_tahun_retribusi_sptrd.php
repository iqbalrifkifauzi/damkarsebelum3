									...
									<div class="btn-group">
										<a  class="btn green" href="<?php echo base_url();?>ga/laporan_realisasi_target_tahunan" >
													Submit Realisasi Target Tahunan <i class="icon-ok"></i>
													</a> 
...
<div class='alert alert-block alert-error show'>
		...
		<span>Data SPTRD Tahun = <?php echo date('Y');?>, Dengan Total Nominal = <?php echo rupiah($totalsemua);?></span>
</div>
