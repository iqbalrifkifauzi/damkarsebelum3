...
<body class="page-header-fixed">
        ...
        <ul class="nav pull-right">
          ...
          <li class="dropdown" id="header_inbox_bar">
            ...
            <ul class="dropdown-menu extended inbox">
              ...
              <li class="external">
                <a href="<?php echo base_url();?>ga/ganti_tahun">Penggantian Tahun <i class="m-icon-swapright"></i></a>
              </li>
            </ul>
          </li>
 ...
 <li class="dropdown" id="header_inbox_bar">
            ...
            foreach ($query2->result_array() as $value) {
              ...
              $query3 =  $this->db->query("select * from tbl_perpanjang_retribusi where year(bulan_retribusi)='$tahun' and  month(bulan_retribusi)='$bulan' and imb_id='$id' ");
...
<!--          <li>
       ...
       <!-- 
            ...
            <li>
              <a href="<?php echo base_url();?>ga/laporan_tahun_pendataan">
            ...
            <li>
             ...
             <li>
              <a href="<?php echo base_url();?>ga/K-Means">
              K-Means
              </a>
            </li>          
  ...
  <div class="footer">
    <div class="footer-inner">
      2020 &copy; DISDAMKAR Powered By Iqbal Rifki Fauzi
    </div>
